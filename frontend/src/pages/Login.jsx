    ...
    <div className="w-full  flex justify-center items-center">
      <div className="sm:px-10 px-2 w-full sm:w-1/2 lg:w-1/2 xl-1/3  transition-all">
        ...
        <form
          ...
          className="w-full overflow-hidden mx-auto bg-white p-4 rounded-2xl shadow-2xl shadow-red-600 text-left font-mono flex flex-col space-y-5"
        >
          <div className="relative z-0 w-full mb-5 group flex flex-col text-left ">
            <input
              ...
              id="floating_email"
              className=" py-3 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
              placeholder=" "
              required
            />
            <label
          ...
          <Link to={"/register"} className="underline text-blue-600 text-right">
            New Member ?
          </Link>
        </form>
      </div>
